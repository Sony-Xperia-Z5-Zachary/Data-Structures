...
public class DrawingPanel extends JPanel {
	...
	public DrawingPanel(TwoDTree tree, final Visualizer visualizer, final TreePanel treePanel) {
		this.tree = tree;
		...
		this.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (e.getButton() == MouseEvent.BUTTON1) {
					DrawingPanel.this.tree.insert(click, visualizer.nextLabel());
				} else {
					try {
						...
						System.out.println(click + "," + DrawingPanel.this.tree.nearestNeighbor(click));
