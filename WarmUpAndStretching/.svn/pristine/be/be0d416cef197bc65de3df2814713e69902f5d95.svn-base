...
public class ShapeTest {
	private static Comparator<Triangle> global_com = new Comparator<Triangle>(){
	...
	public void testSortTrianglesByArea() {
		...
		// implement comparator for triangle 
	...
	public void testSortTrianglesByAreaUsingTreeSet() {
		...
		// create the treeset for triangles and pass the comparator as a parameter 
		TreeSet<Triangle> triangleSet = new TreeSet<Triangle>(global_com); 

		// TODO: 2 Iterate through the unsorted triangles array, adding the
		// triangles
		// to the TreeSet.
		
		// add triangles to the created treeset
